...
- [ ] Montar as cartas das pessoas dentro do meu jogo:
  ...
  - O que mede o nosso relacionamento
  - Quais são as métricas que medem o nosso relacionamento
- [ ] Criar uma pasta de pessoas e dentro delas montar um arquivo para cada pessoa do círculo 1 que vai te ajudar a desenhar para quem pode delegar e quem pode te ajudar.
- [ ] Colocar uma mensagem padrão de foco no WhatsApp: "Olá, agora estou trabalhando em um projeto que exige total concentração e estarei olhando as mensagens tal hora e assim que possível analisarei a sua demanda e responderei o mais breve possível. Se for algo de extrema urgência, me ligue pelo próprio WhatsApp."
- [ ] Montar meus agentes de análise de vida com os exercícios da linha do 100.
...
- [ ] Cancelar a ferramenta de divulgação dos vídeos.
- [ ] Colocar um dia e hora na agenda para o meu compromisso com o financeiro.
- [ ] Colocar um dia e hora de compromisso com o mercado para ter mais previsibilidade.
- [ ] Cancelar a academia e pegar esse tempo sozinho para organizar as coisas na sua mente.
...
- [ ] Focar em ser um bom soldado e entregar tudo que está programado.
- [ ] Ficar bom em planejamento: anual, 90 dias, mensal, semanal.
- [ ] Vini, você precisa travar o tempo de fato, um cronômetro ou contador regressivo para fazer as coisas. Você faz tudo, só que se perde no tempo.
...
- [ ] A sua missão não é o seu propósito e não é a sua essência. Quando estiver no campo de batalha, você precisa ler as pessoas que têm no seu time e ver o que pode extrair delas para seguir o seu plano.
- [ ] Eu tenho padrão inflexível no pensamento, então não posso rebater direto o que estou pensando, preciso de adaptabilidade. Preciso coletar o feedback do ambiente, principalmente do comandante. Quem paga a minha conta? Com isso, preciso me ajustar ao ambiente mais rápido.
- [ ] Eu tenho TDAH, sou neurodivergente e vou falar para essa galera e juntar com a Elo para ganhar força.
...
- [ ] Vini, o planejamento é uma coisa muito cansativa para muitas pessoas e a execução também é. Você precisa ter as duas forças para fazer acontecer. Quando você não tem opção, você não escolhe as duas batalhas, você apenas vai.
